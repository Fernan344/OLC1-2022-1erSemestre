...
break;
case 6:
inicio.listaErrores.push(new errores.default('ERROR LEXICO',$$[$0],_$[$0].first_line,_$[$0].first_column));
break;
case 7:
inicio.listaErrores.push(new errores.default('ERROR SINTACTICO',"Se esperaba token",_$[$0-1].first_line,_$[$0-1].first_column));
break;
case 8:
this.$=new declaracion.default($$[$0-3], new Tipo.default(Tipo.tipoDato.ENTERO), $$[$0-1], _$[$0-4].first_line, _$[$0-4].first_column);
break;
case 9:
...
rules: [/^(?:imprimir\b)/i,/^(?:entero\b)/i,/^(?:;)/i,/^(?:\()/i,/^(?:\))/i,/^(?:\+)/i,/^(?:-)/i,/^(?:=)/i,/^(?:\/)/i,/^(?:\*)/i,/^(?:[ \r\t]+)/i,/^(?:\n)/i,/^(?:"[^\"]*")/i,/^(?:[0-9]+)/i,/^(?:[A-Za-z]+["_"0-9A-Za-z]*)/i,/^(?:$)/i,/^(?:.)/i],
